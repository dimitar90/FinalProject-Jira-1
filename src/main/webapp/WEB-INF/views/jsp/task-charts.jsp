...
<div>
	   	<form action="<c:url value="http://localhost:8080/Jira/charts/taskInfo" />" method="POST">
	              <div class="row" style="height: 20%; display: flex; justify-content: center;">
	                ...
	                <div class="form-group">
			                ...
			                <div class="input-group">
			                  ...
			                  <input type="date" class="form-control pull-right" name="secondDate">
			               	 </div>
			           </div>
	                </div>
	             <div class="col-sm-3" style="display:table-cell; vertical-align:middle; text-align:center">
	                 <div class="form-group">
			                <label><b>Valid date range</b></label>
			              		<input type="text" class="form-control pull-right" name="validLimits" value="${ validDataRange }" disabled>
			            </div>
	                </div>
